                ...
                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <form role="form" id="formAdd" method="POST" action="/pelangganAction" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <textarea name="alamat" placeholder="Maukan Alamat" class="form-control" cols="30" rows="10"></textarea>
                ...
                <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <form role="form" method="POST" id="edit-form" action="/pelangganUpdate" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{ method_field('PUT')}}
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="in_id" placeholder="Masukkan Id" name="id_pelanggan">
                                ...
                                <textarea name="alamat" placeholder="Maukan Alamat" id="in_alamat" class="form-control" cols="30" rows="10"></textarea>
                    ...
                    <tr>
                      ...
                      <tr class="row_data">
                        ...
                        <td>
                          ...
                          <a href="/admin/delete/{{ $d->id_pelanggan }}" onClick="return confirm('Are you sure want to delete?')">
