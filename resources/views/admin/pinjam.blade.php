          ...
          <div class="container-fluid">
            ...
            <div class="box">
                ...
                <table id="detailTable" class="table table-sm table-bordered table-hover attrTable">
                    <tr>
                      <th class="attrName">Kode Peminjaman</th>
                      <th class="attrName">Tanggal Pinjam</th>
                      <th class="attrName">Nama Pelanggan</th>
                      <th class="attrName">Mobil</th>
                      <th class="attrName">Lama Pinjam</th>
                      <th class="attrName">Tanggal Kembali Seharusnya</th>
                      <th class="attrName">Jumlah Bayar</th>
                      <th class="attrName">Status Pemesanan</th>
                    </tr>
